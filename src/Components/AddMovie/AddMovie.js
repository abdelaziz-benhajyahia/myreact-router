...
const AddMovie = ({add}) => {
    ...
    return (
        ...
        <Modal show={show} onHide={handleClose}>
            ...
            <Form.Control type="text" placeholder="Enter Rate" value={rate} onChange={handleRate}/>
            <Form.Label>PosterUrl</Form.Label>
            <Form.Control type="text" placeholder="Enter PosterUrl" value={posterUrl} onChange={handlePosterUrl}/>
            </Modal.Body>
            <Modal.Footer>
